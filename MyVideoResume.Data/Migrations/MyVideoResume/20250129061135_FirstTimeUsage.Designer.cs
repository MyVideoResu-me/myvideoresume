...
namespace MyVideoResume.Data.Migrations.MyVideoResume
{
    ...
    [Migration("20250129061135_FirstTimeUsage")]
    partial class FirstTimeUsage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyVideoResume.Data.Models.Profiles.CompanyProfileEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MyVideoResume.Data.Models.Profiles.UserProfileEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MyVideoResume.Data.Models.Jobs.ApplicantToJobEntity", b =>
                {
                    ...
                    b.HasOne("MyVideoResume.Data.Models.Profiles.UserProfileEntity", "UserApplying")
            ...
            modelBuilder.Entity("MyVideoResume.Data.Models.Jobs.JobItemEntity", b =>
                {
                    ...
                    b.HasOne("MyVideoResume.Data.Models.Profiles.CompanyProfileEntity", "Company")
                        .WithMany()
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("MyVideoResume.Data.Models.Profiles.UserProfileEntity", "ContactUser")
                        .WithMany()
                        .HasForeignKey("ContactUserId1")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("MyVideoResume.Data.Models.Profiles.UserProfileEntity", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("MyVideoResume.Data.Models.Profiles.CompanyProfileEntity", b =>
                {
                    ...
                    b.HasOne("MyVideoResume.Data.Models.Profiles.UserProfileEntity", "UserProfile")
                        .WithMany()
            ...
            modelBuilder.Entity("MyVideoResume.Data.Models.UserCompanyRoleEntity", b =>
                {
                    b.HasOne("MyVideoResume.Data.Models.Profiles.CompanyProfileEntity", "CompanyProfile")
                        .WithMany()

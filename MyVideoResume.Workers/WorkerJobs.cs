...
public class RecurringJobsService : BackgroundService
{
    ...
    protected override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        try
        {
            ...
            _recurringJobs.AddOrUpdate("CrawlWebsiteCreateJobs-SimplyHired-Developer", () => _jobService.CrawlWebsiteCreateJobs("https://www.simplyhired.com/search?q=Developer&l="), Cron.Minutely); //Minutely
